/*
Q.1) Write a program to simulate non pre-emptive Priority CPU-scheduling. The arrival time 
and burst time for different n number of processes should be input to the program.
