/*
Q.1) Write the simulation program to implement FIFO demand paging and show the page 
scheduling and total number of page faults for the following given page reference string 
and the number of memory frames are 4.
Reference String : 2,5,2,8,6,8,1,3,4,7,2,8,2,3,1,6
*/
#include<stdio.h>
#include<stdlib.h>
struct fnode
