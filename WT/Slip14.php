...
sentence and second can be a word. Replace all the characters from the big string 
with the small string after a specified position.
-->
<html>
    <body>
        <form action="name of your php file" method="post">
            ...
            <input type="radio" name="op" value="1">replace word<br>
